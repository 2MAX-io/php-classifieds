 ...
 * @coversNothing
 */
class RegisterAccountTest extends AppIntegrationTestCase
{
    ...
    public function testUserRegister(): void
    {
        ...
        $confirmRegistrationUrl = '$confirmRegistrationUrl not found';
        foreach ($this->getTestContainer()->get('mailer.logger_message_listener')->getEvents()->getMessages() as $message) {
