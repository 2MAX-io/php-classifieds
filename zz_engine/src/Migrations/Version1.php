...
final class Version1 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE package (id INT UNSIGNED AUTO_INCREMENT NOT NULL, name VARCHAR(50) NOT NULL, admin_name VARCHAR(70) NOT NULL, default_package TINYINT(1) NOT NULL, price INT NOT NULL, days_featured_expire SMALLINT UNSIGNED NOT NULL, days_listing_expire SMALLINT UNSIGNED NOT NULL, removed TINYINT(1) NOT NULL, description VARCHAR(10000) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
