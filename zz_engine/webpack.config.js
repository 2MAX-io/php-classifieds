...
Encore
    ...
    .addEntry('listing_list', './assets/public/listing_list/listing_list.js')
    .addEntry('listing_list_map', './assets/public/listing_list/listing_list_map.js')
    ...
    .addEntry('admin_listing_reject', './assets/admin/page/listing/admin_listing_reject.js')
