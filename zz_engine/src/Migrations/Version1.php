...
final class Version1 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE category (id INT UNSIGNED AUTO_INCREMENT NOT NULL, parent_id INT UNSIGNED DEFAULT NULL, name VARCHAR(50) NOT NULL, lvl SMALLINT UNSIGNED NOT NULL, lft SMALLINT UNSIGNED NOT NULL, rgt SMALLINT UNSIGNED NOT NULL, sort SMALLINT UNSIGNED NOT NULL, slug VARCHAR(100) NOT NULL, picture VARCHAR(100) DEFAULT NULL, UNIQUE INDEX UNIQ_64C19C1989D9B62 (slug), INDEX IDX_64C19C1727ACA70 (parent_id), INDEX lft_rgt (lft, rgt), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE custom_field (id INT UNSIGNED AUTO_INCREMENT NOT NULL, name VARCHAR(40) NOT NULL, name_for_admin VARCHAR(50) DEFAULT NULL, type VARCHAR(40) NOT NULL, required TINYINT(1) NOT NULL, searchable TINYINT(1) NOT NULL, sort SMALLINT UNSIGNED NOT NULL, unit VARCHAR(25) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE custom_field_join_category (id INT UNSIGNED AUTO_INCREMENT NOT NULL, category_id INT UNSIGNED NOT NULL, custom_field_id INT UNSIGNED NOT NULL, sort SMALLINT UNSIGNED NOT NULL, INDEX IDX_13CF18A312469DE2 (category_id), INDEX IDX_13CF18A3A1E5E0D4 (custom_field_id), UNIQUE INDEX unique_field_category_pair (custom_field_id, category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE payment (id INT UNSIGNED AUTO_INCREMENT NOT NULL, user_id INT UNSIGNED NOT NULL, type VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, amount INT NOT NULL, gateway_amount_paid INT DEFAULT NULL, currency VARCHAR(10) NOT NULL, datetime DATETIME NOT NULL COMMENT \'(DC2Type:datetime)\', gateway_status VARCHAR(255) NOT NULL, paid TINYINT(1) NOT NULL, delivered TINYINT(1) NOT NULL, canceled TINYINT(1) NOT NULL, gateway_payment_id VARCHAR(255) NOT NULL, gateway_transaction_id VARCHAR(255) DEFAULT NULL, gateway_token VARCHAR(255) NOT NULL, app_token VARCHAR(70) NOT NULL, gateway_name VARCHAR(70) NOT NULL, gateway_mode VARCHAR(70) NOT NULL, INDEX IDX_6D28840DA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE setting (id INT UNSIGNED AUTO_INCREMENT NOT NULL, name VARCHAR(70) NOT NULL, value VARCHAR(5000) NOT NULL, last_update_date DATETIME NOT NULL COMMENT \'(DC2Type:datetime)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user_invoice_details (id INT UNSIGNED AUTO_INCREMENT NOT NULL, user_id INT UNSIGNED DEFAULT NULL, company_name VARCHAR(255) NOT NULL, tax_number VARCHAR(50) DEFAULT NULL, city VARCHAR(100) NOT NULL, street VARCHAR(255) DEFAULT NULL, building_number VARCHAR(50) NOT NULL, unit_number VARCHAR(50) DEFAULT NULL, zip_code VARCHAR(50) NOT NULL, country VARCHAR(50) DEFAULT NULL, email_for_invoice VARCHAR(255) NOT NULL, created_date DATETIME NOT NULL COMMENT \'(DC2Type:datetime)\', updated_date DATETIME NOT NULL COMMENT \'(DC2Type:datetime)\', INDEX IDX_922351D6A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE zzzz_executed_upgrade (id INT UNSIGNED AUTO_INCREMENT NOT NULL, name VARCHAR(150) NOT NULL, upgrade_id INT NOT NULL, executed_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE zzzz_police_log_listing (id INT UNSIGNED AUTO_INCREMENT NOT NULL, datetime DATETIME NOT NULL COMMENT \'(DC2Type:datetime)\', source_ip VARCHAR(50) NOT NULL, destination_ip VARCHAR(50) NOT NULL, text LONGTEXT NOT NULL, listing_id INT UNSIGNED DEFAULT NULL, user_id INT UNSIGNED DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE zzzz_police_log_user_message (id INT UNSIGNED AUTO_INCREMENT NOT NULL, datetime DATETIME NOT NULL COMMENT \'(DC2Type:datetime)\', source_ip VARCHAR(50) NOT NULL, destination_ip VARCHAR(50) NOT NULL, text LONGTEXT NOT NULL, listing_id INT UNSIGNED DEFAULT NULL, user_id INT UNSIGNED DEFAULT NULL, user_message_id INT UNSIGNED DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE custom_field_join_category ADD CONSTRAINT FK_13CF18A312469DE2 FOREIGN KEY (category_id) REFERENCES category (id)');
        $this->addSql('ALTER TABLE custom_field_join_category ADD CONSTRAINT FK_13CF18A3A1E5E0D4 FOREIGN KEY (custom_field_id) REFERENCES custom_field (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE custom_field_join_category DROP FOREIGN KEY FK_13CF18A312469DE2');
        ...
        $this->addSql('ALTER TABLE custom_field_join_category DROP FOREIGN KEY FK_13CF18A3A1E5E0D4');
        ...
        $this->addSql('DROP TABLE custom_field_join_category');
